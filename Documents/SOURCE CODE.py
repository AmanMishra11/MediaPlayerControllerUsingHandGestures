...
cv2.createTrackbar("Upper_H", "Color Adjustments", 237, 255, nothing)
...
while True:
    ...
    cv2.rectangle(frame, (0, 1), (300, 500),(255,0,255), 0)
    crop_image = frame[1:500, 0:300]
    fpsReader.update(crop_image)
    # Step -2
    ...
    try:
        ...
        if count_defects == 0:
            ...
            cv2.putText(frame, " ", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,(0,0,255), 2, 2)
        elif count_defects == 1:

            p.press("space")
            cv2.putText(frame, "Play/Pause", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,(0,0,255), 2, 2)
        elif count_defects == 2:
            p.press("up")

            cv2.putText(frame, "Volume UP", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,(0,0,255), 2, 2)
        elif count_defects == 3:
            p.press("down")

            cv2.putText(frame, "Volume Down", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,(0,0,255), 2, 2)
        elif count_defects == 4:
            p.press("right")

            cv2.putText(frame, "Forward", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, (0,0,255),                          2, 2)
        else:
            pass
